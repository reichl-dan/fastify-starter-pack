 ...
 * @typedef {import('pino').LoggerOptions} PinoLoggerOptions
 * @typedef {Partial<PinoLoggerOptions>} LoggerPluginOptions
 */
 ...
 * @param {Partial<PinoLoggerOptions>} [options] - Logger configuration options
